...
import static net.werpu.tools.supportive.reflectRefact.navigation.TreeQueryEngine.PARENT;
 ...
 */
@AllArgsConstructor
public class L18NDeclFileTransformation  implements IArtifactTransformation{

    public static final String QUOT = "\"";
    L18NFileContext target;
    L18NTransformationModel transformationModel;

    String neyKey;

    String newValue;

    public L18NDeclFileTransformation(L18NFileContext target, String neyKey, String newValue) {
        this.target = target;
        this.neyKey = neyKey;
